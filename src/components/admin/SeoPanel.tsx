 ...
 *
 * Lives inside an `EditorSection`, which owns the collapse — this renders the
 * fields only.
 *
...
export function SeoPanel({
  ...
  return (
    <div className="seo-panel">
      ...
      <p className="hint">
        Keeps the post live and linkable but out of search results. It is also
        dropped from the sitemap — listing a URL while telling crawlers to
        ignore it is reported as an error.
      </p>
    </div>
  );
}
