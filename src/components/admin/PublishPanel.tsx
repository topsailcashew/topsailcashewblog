...
export function PublishPanel({
  ...
  return (
    <div className="field publish-panel">
 ...
 * reading it during render would produce a value that changes on any
 * re-render. Subscribing to it instead makes the reading stable *and* makes
 * the "Scheduled for…" banner clear itself when the moment arrives, rather
 * than sitting there until something else causes a render.
 */
function useIsFuture(iso: string | null): boolean {
